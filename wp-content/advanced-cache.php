...
if ( version_compare( phpversion(), '5.6' ) >= 0 ) {
	...
	spl_autoload_register(
		function( $class ) {
			$rocket_path    = '/Volumes/Work/Beetroot/e-Shop/wp-content/plugins/wp-rocket/';
			$rocket_classes = [
	...
	$rocket_config_class = new \WP_Rocket\Buffer\Config(
		[
			'config_dir_path' => '/Volumes/Work/Beetroot/e-Shop/wp-content/wp-rocket-config/',
		]
	);
	...
	( new \WP_Rocket\Buffer\Cache(
		...
		$rocket_config_class,
		[
			'cache_dir_path' => '/Volumes/Work/Beetroot/e-Shop/wp-content/cache/wp-rocket/',
		]
	) )->maybe_init_process();
} else {
