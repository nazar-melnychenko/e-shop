								...
								<li class="arrow-plus">
									...
									<div class="cat-left-drop-menu cat-left-drop-menu-photo-contain">
										...
										<div class="cat-left-drop-menu-left cat-left-drop-menu-photo">
											<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/megamenu/vmega_blog1.jpg" alt="Product"></a>
										</div>
									</div>
									<!-- MEGA MENU END -->
								</li>
						...
						<div class="active-bestseller sidebar">
							<div class="col-xs-12">
								...
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="primary-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/small/1.jpg" alt="Product">
										</a>
									</div>
								...
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="primary-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/small/2.jpg" alt="Product">
										</a>
									</div>
									<div class="product-description">
										<h5><a href="#">Various Versions</a></h5>
								...
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="primary-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/small/3.jpg" alt="Product">
										</a>
									</div>
									<div class="product-description">
										<h5><a href="#">Various Versions</a></h5>
								...
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="primary-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/small/4.jpg" alt="Product">
										</a>
									</div>
									<div class="product-description">
										<h5><a href="#">Various Versions</a></h5>
							...
							<div class="col-xs-12">
								...
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="primary-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/small/5.jpg" alt="Product">
										</a>
									</div>
									<div class="product-description">
										<h5><a href="#">Various Versions</a></h5>
								...
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="primary-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/small/6.jpg" alt="Product">
										</a>
									</div>
									<div class="product-description">
										<h5><a href="#">Various Versions</a></h5>
								...
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="primary-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/small/7.jpg" alt="Product">
										</a>
									</div>
									<div class="product-description">
										<h5><a href="#">Various Versions</a></h5>
								...
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="primary-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/product/small/8.jpg" alt="Product">
										</a>
									</div>
									<div class="product-description">
										<h5><a href="#">Various Versions</a></h5>
		...
		<div class="container">
			...
			<div class="row">
				<div class="active-brand-logo">
					...
					<div class="col-md-2">
						<div class="single-brand-logo">
							<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/4.png" alt=""></a>
						</div>
					</div>
					<div class="col-md-2">
						<div class="single-brand-logo">
							<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/5.png" alt=""></a>
						</div>
					</div>
					<div class="col-md-2">
						<div class="single-brand-logo">
							<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/6.png" alt=""></a>
						</div>
					</div>
					<div class="col-md-2">
						<div class="single-brand-logo">
