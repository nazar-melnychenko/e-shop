...
if( ! class_exists( 'YITH_Woocompare_Frontend_Premium' ) ) {
    ...
    class YITH_Woocompare_Frontend_Premium extends YITH_Woocompare_Frontend {
	    ...
	    public function add_compare_link( $product_id = false, $args = array() ) {
		    ...
		    printf( '<a href="%s" class="compare %s" data-product_id="%s" rel="nofollow" target="%s">%s</a>', $link, $class, $product_id, $button_target, $button_text );
	    }
        ...
        public function related_product() {
	        ...
	        // check for page/popup
	        $toShow  = get_option( 'yith-woocompare-related-in-page', 'yes' ) == 'yes' && $this->is_iframe != 'yes';
	        ! $toShow && $toShow = get_option( 'yith-woocompare-related-in-popup', 'yes' ) == 'yes';
